    ...
    <div class="-mx-3 flex flex-wrap">
        <div class="w-full max-w-full flex-none px-3">
            ...
            <div
                ...
                <div class="flex-auto px-0 pb-2 pt-0">
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                        <form action="{{ route('laporan.participant.pdf') }}" method="post" enctype="multipart/form-data"
                            target="_blank">
                            @csrf
            ...
            <div
                ...
                <div class="flex-auto px-0 pb-2 pt-0">
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                        <form action="{{ route('laporan.participant') }}" method="get" enctype="multipart/form-data"
                            class="mb-3">
                            <div class="w-full flex flex-wrap justify-center gap-2 lg:flex-nowrap">
                                @role(['owner', 'pic'])
                                    <label class="form-control w-full lg:w-1/3">
