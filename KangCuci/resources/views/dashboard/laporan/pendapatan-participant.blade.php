    ...
    <div class="-mx-3 flex flex-wrap">
        <div class="w-full max-w-full flex-none px-3">
            ...
            <div
                ...
                <div class="flex-auto px-0 pb-2 pt-0">
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                        <form action="{{ route('laporan.pendapatan.participant.pdf') }}" method="post"
            ...
            <div
                ...
                <div class="flex-auto px-0 pb-2 pt-0">
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                        <form action="{{ route('laporan.pendapatan.participant') }}" method="get"
                        ...
                        <div>
                            ...
                            <div class="w-full flex flex-wrap justify-center gap-2 lg:flex-nowrap">
                                <label class="form-control w-full lg:w-1/2">
                                    ...
                                    <input type="text" name="total_pendapatan_laundry"
                                        value="{{ $transaksi->where('status', 'participant')->count() }} orang"
                                ...
                                <label class="form-control w-full lg:w-1/2">
                                    ...
                                    <input type="text" name="total_pendapatan_laundry"
                                        value="{{ $transaksi->where('status', 'Lulus')->count() }} orang"
                                        class="input input-bordered w-full text-green-700 dark:bg-slate-100" readonly />
                                </label>
                            </div>
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="total_pendapatan_laundry"
                                    value="Rp{{ number_format($transaksi->sum('upah') - $transaksi->sum('pemasukkan_participant'), 2, ',', '.') }}"
                                    class="input input-bordered w-full text-green-700 dark:bg-slate-100" readonly />
                            </label>
                        </div>
                    </div>
