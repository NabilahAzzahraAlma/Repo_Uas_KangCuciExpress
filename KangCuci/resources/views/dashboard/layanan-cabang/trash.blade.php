        ...
        <div class="w-full max-w-full flex-none px-3">
            <div
                ...
                <div
                    ...
                    <h6 class="text-xl font-bold text-green-700 dark:text-white">{{ $cabang->nama }}</h6>
                    <a href="{{ route('layanan-cabang.cabang', $cabang->slug) }}"
            ...
            <div
                ...
                <div
                    ...
                    <h6 class="font-bold dark:text-white">Jenis Layanan Trash <span class="text-error">(data yang telah
                            dihapus)</span></h6>
                </div>
                                        ...
                                        <td class="border-b border-slate-600 bg-transparent text-left align-middle">
                                            <div>
                                                ...
                                                @if (!$cabang->deleted_at)
                                                    @role('pic')
                                                        <label for="restore_button_jenis_layanan"
                                                            class="btn btn-outline btn-primary btn-sm"
                                                            onclick="return restore_button_jenis_layanan('{{ $item->id }}', '{{ $item->cabang_id }}', '{{ $item->nama }}')">
                                                            <i class="ri-history-line text-base"></i>
                                                        </label>
                                                        <label for="destroy_button_jenis_layanan"
                                                            class="btn btn-outline btn-error btn-sm"
                                                            onclick="return destroy_button_jenis_layanan('{{ $item->id }}', '{{ $item->cabang_id }}', '{{ $item->nama }}')">
                                                            Hapus Permanen
                                                        </label>
                                                    @endrole
                                                @endif
            ...
            <div
                ...
                <div
                    class="border-b-solid mb-0 flex items-center justify-between rounded-t-2xl border-b-0 border-b-transparent p-6 pb-3">
                    <h6 class="font-bold dark:text-white">Jenis Pakaian Trash <span class="text-error">(data yang telah
                            dihapus)</span></h6>
                </div>
                <div class="flex-auto px-0 pb-2 pt-0">
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b border-slate-600 bg-transparent text-left align-middle">
                                            <div>
                                                ...
                                                @if (!$cabang->deleted_at)
                                                    @role('pic')
                                                        <label for="restore_button_jenis_pakaian"
                                                            class="btn btn-outline btn-primary btn-sm"
                                                            onclick="return restore_button_jenis_pakaian('{{ $item->id }}', '{{ $item->cabang_id }}', '{{ $item->nama }}')">
                                                            <i class="ri-history-line text-base"></i>
                                                        </label>
                                                        <label for="destroy_button_jenis_pakaian"
                                                            class="btn btn-outline btn-error btn-sm"
                                                            onclick="return destroy_button_jenis_pakaian('{{ $item->id }}', '{{ $item->cabang_id }}', '{{ $item->nama }}')">
                                                            Hapus Permanen
                                                        </label>
                                                    @endrole
                                                @endif
            ...
            <div
                ...
                <div
                    class="border-b-solid mb-0 flex items-center justify-between rounded-t-2xl border-b-0 border-b-transparent p-6 pb-3">
                    <h6 class="font-bold dark:text-white">Harga Jenis Layanan Trash <span class="text-error">(data yang
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b border-slate-600 bg-transparent text-left align-middle">
                                            <div>
                                                ...
                                                @if (!$cabang->deleted_at)
                                                    @role('pic')
                                                        <label for="restore_button_harga_jenis_layanan"
                                                            class="btn btn-outline btn-primary btn-sm"
                                                            onclick="return restore_button_harga_jenis_layanan('{{ $item->id }}', '{{ $item->nama_layanan }}', '{{ $item->nama_pakaian }}')">
                                                            <i class="ri-history-line text-base"></i>
                                                        </label>
                                                        <label for="destroy_button_harga_jenis_layanan"
                                                            class="btn btn-outline btn-error btn-sm"
                                                            onclick="return destroy_button_harga_jenis_layanan('{{ $item->id }}', '{{ $item->nama_layanan }}', '{{ $item->nama_pakaian }}')">
                                                            Hapus Permanen
                                                        </label>
                                                    @endrole
                                                @endif
            ...
            <div
                ...
                <div
                    class="border-b-solid mb-0 flex items-center justify-between rounded-t-2xl border-b-0 border-b-transparent p-6 pb-3">
                    <h6 class="font-bold dark:text-white">Layanan Prioritas Trash <span class="text-error">(data yang
                            telah dihapus)</span></h6>
                </div>
                <div class="flex-auto px-0 pb-2 pt-0">
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b border-slate-600 bg-transparent text-left align-middle">
                                            <div>
                                                ...
                                                @if (!$cabang->deleted_at)
                                                    @role('pic')
                                                        <label for="restore_button_layanan_prioritas"
                                                            class="btn btn-outline btn-primary btn-sm"
                                                            onclick="return restore_button_layanan_prioritas('{{ $item->id }}', '{{ $item->nama }}')">
                                                            <i class="ri-history-line text-base"></i>
                                                        </label>
                                                        <label for="destroy_button_layanan_prioritas"
                                                            class="btn btn-outline btn-error btn-sm"
                                                            onclick="return destroy_button_layanan_prioritas('{{ $item->id }}', '{{ $item->nama }}')">
                                                            Hapus Permanen
                                                        </label>
                                                    @endrole
                                                @endif
            ...
            <div
                ...
                <div
                    class="border-b-solid mb-0 flex items-center justify-between rounded-t-2xl border-b-0 border-b-transparent p-6 pb-3">
                    <h6 class="font-bold dark:text-white">Layanan Tambahan Trash <span class="text-error">(data yang telah
                            dihapus)</span></h6>
                </div>
                <div class="flex-auto px-0 pb-2 pt-0">
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b border-slate-600 bg-transparent text-left align-middle">
                                            <div>
                                                ...
                                                @if (!$cabang->deleted_at)
                                                    @role('pic')
                                                        <label for="restore_button_layanan_tambahan"
                                                            class="btn btn-outline btn-primary btn-sm"
                                                            onclick="return restore_button_layanan_tambahan('{{ $item->id }}', '{{ $item->cabang_id }}', '{{ $item->nama }}')">
                                                            <i class="ri-history-line text-base"></i>
                                                        </label>
                                                        <label for="destroy_button_layanan_tambahan"
                                                            class="btn btn-outline btn-error btn-sm"
                                                            onclick="return destroy_button_layanan_tambahan('{{ $item->id }}', '{{ $item->cabang_id }}', '{{ $item->nama }}')">
                                                            Hapus Permanen
                                                        </label>
                                                    @endrole
                                                @endif
