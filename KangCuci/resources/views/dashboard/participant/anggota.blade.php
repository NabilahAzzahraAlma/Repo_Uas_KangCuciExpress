...
@section('js')
    <script>
        ...
        function show_button(id) {
            ...
            $.ajax({
                type: "get",
                url: "{{ route('participant.anggota.show') }}",
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": id
                },
                ...
                <div class="modal-box">
                    ...
                    <div>
                        ...
                        <label class="form-control w-full">
                            ...
                            <input type="text" name="ttl" class="input input-bordered w-full text-green-700"
                                readonly />
                        </label>
                        <label class="form-control w-full">
                            <div class="label">
            ...
            <div
                ...
                <div
                    ...
                    <div class="mb-3">
                        ...
                        <h6 class="font-bold dark:text-white">No.Kartu Keluarga: <span
                                class="text-green-500">{{ $participant->kartu_keluarga }}</span></h6>
                    </div>
                ...
                <div class="flex-auto px-0 pb-2 pt-0">
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                        <table id="myTable"
                            ...
                            <tbody>
                                @foreach ($detailparticipant as $item)
                                    <tr>
