                ...
                <div
                    ...
                    <div>
                        ...
                        @if (!$cabang->deleted_at)
                            ...
                            @else
                                <a href="{{ route('transaksi.edit', ['transaksi' => $transaksi->id, 'isJadwal' => $isJadwal]) }}"
                            ...
                            <tbody>
                                @foreach ($detailTransaksi as $item)
                                    <tr>
                                        ...
                                        <td class="border-b border-slate-600 bg-transparent text-left align-middle">
                                            <div>
                                                <a href="{{ route('transaksi.view.layanan', ['transaksi' => $item->transaksi_id, 'detailTransaksi' => $item->id]) }}"
