        ...
        <div class="w-full max-w-full flex-none px-3">
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        @if ($isJadwal)
                            <a href="{{ route('transaksi.owner.cabang.jadwal', $cabang->slug) }}"
                        ...
                        @else
                            <a href="{{ route('transaksi.owner.cabang', $cabang->slug) }}"
                                class="bg-150 active:opacity-85 tracking-tight-rem bg-x-25 mb-0 inline-block cursor-pointer rounded-lg border border-solid border-slate-500 dark:border-white bg-transparent px-4 py-1 text-center align-middle text-sm font-bold leading-normal text-slate-500 dark:text-white shadow-none transition-all ease-in hover:-translate-y-px hover:opacity-75 md:px-8 md:py-2">
                                <i class="ri-arrow-left-line"></i>
                                Kembali
                            </a>
                        ...
                        @if (!$cabang->deleted_at)
                            @role(['manajer_laundry', 'pegawai_laundry'])
                                <a href="{{ route('transaksi.owner.cabang.edit', ['cabang' => $cabang->slug, 'transaksi' => $transaksi->id, 'isJadwal' => $isJadwal]) }}"
                ...
                <div class="flex-auto px-6 pb-6 pt-0">
                    ...
                    <div class="w-full flex flex-wrap justify-center gap-2 lg:flex-nowrap">
                        ...
                        <label class="form-control w-full lg:w-1/3">
                            ...
                            <input type="text" name="total_biaya_layanan_tambahan"
                                class="input input-bordered w-full text-green-700 dark:bg-slate-100"
                                value="Rp{{ $transaksi->total_biaya_layanan_tambahan ? number_format($transaksi->total_biaya_layanan_tambahan, 2, ',', '.') : '-' }}"
                                readonly />
                        </label>
                    </div>
                    <label class="form-control w-full">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b border-slate-600 bg-transparent text-left align-middle">
                                            <p
                                                class="text-base font-semibold leading-tight text-slate-500 dark:text-slate-200">
                                                {{ $item->total_pakaian }}
                                                {{ $item->detailLayananTransaksi[0]->hargaJenisLayanan->jenis_satuan }}
                                            </p>
                                        </td>
                                        <td class="border-b border-slate-600 bg-transparent text-left align-middle">
                                            <p
                                        ...
                                        <td class="border-b border-slate-600 bg-transparent text-left align-middle">
                                            <div>
                                                <a href="{{ route('transaksi.owner.view.layanan', ['cabang' => $cabang->slug, 'transaksi' => $item->transaksi_id, 'detailTransaksi' => $item->id]) }}"
