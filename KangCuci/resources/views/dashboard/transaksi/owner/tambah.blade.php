                        ...
                        if (result.isConfirmed) {
                            if ({{ $isJadwal }}) {
                                return window.location.href =
                                    "{{ route('transaksi.owner.cabang.jadwal', $cabang->slug) }}";
                            }
                            return window.location.href =
                                "{{ route('transaksi.owner.cabang', $cabang->slug) }}";
                        }
                    });
                },
                error: function(data) {
                        ...
                        <div class="w-full flex flex-wrap justify-center gap-2 lg:flex-nowrap">
                            ...
                            <label class="form-control w-full lg:w-1/2">
                                ...
                                <select name="participant_id"
                                    ...
                                    <option value="null">Tidak Perlu participant</option>
                            ...
                            <div class="w-full flex flex-wrap justify-center gap-2 lg:flex-nowrap">
                                ...
                                <label class="form-control w-full">
                                    ...
                                    <input type="number" min="0" value="0"
                                        name="total_biaya_layanan_tambahan" placeholder="Total Biaya Layanan Tambahan"
                                        class="input input-bordered w-full text-green-700 bg-slate-300" readonly
                                        required />
                                </label>
                            </div>
                            <div class="w-full">
