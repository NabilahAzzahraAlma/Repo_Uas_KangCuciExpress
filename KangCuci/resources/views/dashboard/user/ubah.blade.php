                        ...
                        <label id="form_kk_participant" class="form-control w-full">
                            ...
                            <select name="participant_id" class="select select-bordered" required>
                                ...
                                @foreach ($kkparticipant as $item)
                                    <option
                                        value="{{ $item->id }}"
                                        @if ($item->id == $profile->participant_id) selected @endif
                                        >
                                ...
                                <select name="role"
                                    ...
                                    @foreach ($role as $item)
                                        <option value="{{ $item->name }}"
                                            @if ($item->name == $user->roles[0]->name) selected @endif>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                                @error('role')
                                    <div class="label">
                                ...
                                <select name="cabang_id"
                                    ...
                                    @foreach ($cabang as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($item->id == auth()->user()->cabang_id || $item->id == $user->cabang_id) selected @endif>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                @error('cabang_id')
                                    <div class="label">
